...
student = {'name': 'tasnia', 'roll_number': 'c193249', 'grades': {'math': 85, 'science': 90, 'history': 75}}
...
# Updating elements
student['grades']['science'] = 95  # Update science grade
student['grades']['english'] = 80  # Add English grade
print("Updated Student Dictionary:")
print(student)

# Removing elements
removed_grade = student['grades'].pop('history')  # Remove history grade
